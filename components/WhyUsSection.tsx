      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 md:px-10">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-balance text-white/80 text-sm">
            Chez SERVSI, nous croyons que la technologie doit être un moteur de
            croissance, jamais un frein. Notre rôle est de transformer vos
            infrastructures IT en véritables leviers de performance et de
            sécurité.
          </p>
        </div>
        ...
        >
          <div className="group relative rounded-[2rem] border border-white/10 bg-[#0a1f21] p-2 shadow-2xl">
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 backdrop-blur-sm animate-bounce">
            ...
            >
              <div className="rounded-2xl bg-white/10 p-5 text-white/90 backdrop-blur-md ring-1 ring-white/15 animate-bounce">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16 md:px-10">
        ...
        <div className="mx-auto mt-10 grid max-w-6xl grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <article className="rounded-[1.5rem] border-2 border-white/10 bg-transparent p-6 shadow-lg ring-2 ring-white/10 md:p-8">
